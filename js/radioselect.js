...
function enablePlanSelection() {
    ...
    document.getElementById('card-body01').innerHTML = `
        ...
        <p class="card-text">por solo $${basicPolicy.totalAmountMonth.toFixed(2)} mensuales (*).</p>
    `;
    document.getElementById('card-body02').innerHTML = `
        ...
        <p class="card-text">por solo $${standardPolicy.totalAmountMonth.toFixed(2)} mensuales (*).</p>
    `;
    document.getElementById('card-body03').innerHTML = `
        ...
        <p class="card-text">por solo $${premiumPolicy.totalAmountMonth.toFixed(2)} mensuales (*).</p>
    `;
